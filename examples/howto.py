...
def textExample():
  ...
  t=[{'t': "In this section we'll explain the format of the text parameter"},
     ...
     {'t': "   {'tn': 'example', 'tc': ['Header one', {'t': 'Header two', 'm': 'title'}] }"},
     {'t': "   {'tn': 'example', 'tc': ['Some text to fill cell one', 'cell two']}"},
     {'t': " "},
     ...
     {'t': "  tn -> the name of the table (tn for table name)"},
     {'t': "  tc -> the cells of the table. These follow the same format as any text"},
     {'t': " "},
